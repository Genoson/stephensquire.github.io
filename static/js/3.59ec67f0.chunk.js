  ...
  [3],
  {
    17: function (t, e, n) {
      ...
      var i,
            ...
            a = function (t) {
              "first-contentful-paint" === t.name &&
                ...
                t.startTime < i.timeStamp &&
                  ((r.value = t.startTime), r.entries.push(t), p.add(r), n()));
            },
            ...
            f(function (i) {
              (r = u("FCP")),
                ...
                requestAnimationFrame(function () {
                  requestAnimationFrame(function () {
                    (r.value = performance.now() - i.timeStamp), p.add(r), n();
                  });
                });
            }));
        },
        ...
        w = function (t, e) {
          i ||
            ((i = e), (r = t), (a = new Date()), b(removeEventListener), L());
        },
        L = function () {
          if (r >= 0 && r < a - E) {
            var t = {
        ...
        k = function (t, e) {
          var n,
            ...
            a = function (t) {
              var e = t.startTime;
              e < i.timeStamp && ((r.value = e), r.entries.push(t)), n();
            },
          ...
          if (o) {
            ...
            var d = function () {
              p.has(r) ||
                (o.takeRecords().map(a), o.disconnect(), p.add(r), n());
            };
...
//# sourceMappingURL=3.59ec67f0.chunk.js.map
